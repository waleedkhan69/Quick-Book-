              ...
              {savedTemplates.map((template, index) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Payee: {template.payee}</p>
                    <p className="text-sm text-gray-500">Amount: {template.amount}</p>
                    <p className="text-sm text-gray-500">Memo: {template.memo}</p>
                  </div>
                  <button
