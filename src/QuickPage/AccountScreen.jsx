...
const AccountScreen = () => {
  ...
  const [nestedLevels, setNestedLevels] = useState([{ level: 1, subAccount: '' }]);
  ...
  const addNestedLevel = () => {
    if (nestedLevels.length < 7) {
      setNestedLevels([...nestedLevels, { level: nestedLevels.length + 1, subAccount: '' }]);
    }
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      <h2 className="text-2xl font-semibold text-center">Control Account Costs</h2>
      ...
      <form onSubmit={handleSubmit} className="bg-white p-6 shadow-lg rounded-lg">
        ...
        {/* Nested Levels */}
        <div className="mt-6">
          <h3 className="text-lg font-medium mb-4">Sub-Accounts (up to 7 levels)</h3>
